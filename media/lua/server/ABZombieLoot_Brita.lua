...
local function addBritaLoot(lootTable)
  if getActivatedMods():contains("Brita") then
    ...
    local britaGunBags = {
      {item = "Case_Small1", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true},
      {item = "Case_Small2", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true},
      {item = "Case_Small3", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true},
      {item = "Case_Small4", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true},
      {item = "Case_Small5", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true},
      {item = "Case_Small6", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true},
      {item = "Case_Small7", chance = AB_get_chance(0.1, GunBagMultiplier), isGunCase = true}
    }
